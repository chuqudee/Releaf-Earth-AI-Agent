...
def generate_sql_query(user_input):
    ...
    A supplier name in "name" column in P1_Purchase table, can perform more than one supply or transaction in a day or week. so their names can be duplicated in rows. Always select DISTINCT when getting the names of suppliers.
